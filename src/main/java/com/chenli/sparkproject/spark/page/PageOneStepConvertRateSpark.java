package com.chenli.sparkproject.spark.page;
...
import com.chenli.sparkproject.util.NumberUtils;
...
public class PageOneStepConvertRateSpark {
    ...
    private static Map<String, Double> computePageSplitConvertRate(
        ...
        String[] targetPages = ParamUtils.getParam(
